...
export const NEXT_PUBLIC_WC_PROJECT_ID = "38bc8db93023d6fe9670903ed8d8ae8";
console.log("Loaded WC Project ID from config:", process.env.NEXT_PUBLIC_WC_PROJECT_ID);
